...
from utils.pdf_converter import convert_md_to_pdf_file
...
def convert_md_to_pdf(
    ...
    """
    将Markdown文档转换为PDF（优先WeasyPrint引擎，跨平台；Windows下无WeasyPrint时自动降级Word引擎）
    ...
    try:
        ...
        # 4. 调用核心转换逻辑（统一入口：WeasyPrint 优先，Word COM 兜底）
        return convert_md_to_pdf_file(md_abs_path, pdf_abs_path)
